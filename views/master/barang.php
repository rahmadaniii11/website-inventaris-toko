    ...
    if (x == 'add') {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $('[name="kadaluarsa"]').val(data.kadaluarsa);
            }
        });
    }
}
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group ">
                                <label for="harga" class="control-label col-lg-2"
                                       style="text-align: left;">Harga </label>
                                <div class="col-lg-5">
                                    <input class="form-control " id="rupiah" type="number" name="harga"/>
                                </div>
                            </div>
                        <div class="mb-3">
                        <<label for="kadaluarsa" class="form-label"> kadaluarsa</label>
                        <input type="date" class="form-control" id="kadaluarsa" name="kadaluarsa" value="<?php echo $row['kadaluarsa']; ?>">
                    </div>
                  </div>
